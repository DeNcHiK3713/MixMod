    ...
    public static class ZoneHand_GetCardPosition
    {
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            if (index > 0)
            {
                ...
                newInstructions.Insert(index++, new CodeInstruction(OpCodes.Ldflda, typeof(ZoneHand).GetField("centerOfHand", BindingFlags.NonPublic | BindingFlags.Instance)));
                ...
                newInstructions.Insert(index++, new CodeInstruction(OpCodes.Ldloc_3));
                ...
                newInstructions.Insert(index++, new CodeInstruction(OpCodes.Sub));
                newInstructions.Insert(index++, new CodeInstruction(OpCodes.Stloc_S, (byte)9));
